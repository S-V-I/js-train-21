...
// console.log(new Musician("Name", "Instrument").play());
...
class Guitarist extends Musician {
  ...
  // виклик конструктора батьківського класу super з двома параметрами
  // name, instrument
...
// console.log(new Guitarist("Name", "Instrument", "Band").play());
...
// console.log(new Bassist("Name", "Instrument", "Band").play());
...
// Другий аргумент - це ім'я властивості, яку ми хочемо додати.
// У цьому випадку це 'band'.
// Третій аргумент - це об'єкт, який описує властивість.
// У цьому випадку ми хочемо додати сетер,
// тому ми вказуємо функцію, яка буде викликатися при спробі
// встановити властивість 'band'.  this.band = newBand
...
class Band {
   ...
   * #members - це масив об'єктів, що є екземплярами класу Musician
   * або його нащадків
   */
  ...
  // Якщо ні виводимо в консоль повідомлення Новий учасник повинен
  // бути екземпляром класу Musician
  // Створюємо метод playMusic(), за допомогою forEach перебираємо
  // масив і викликаємо метод play() для кожного учасника гурту
  #name;
  #members;
...
// console.log(new Band("Name", "Members").addMember());
...
class Performance {
  ...
  // `Гурт ${this.#band.name} виступить в ${this.#location}
...
// console.log(new Performance("Band", "Location", "Date").info());
...
class Concert extends Performance {
  ...
  // Створюємо конструктор з чотирма вхідними параметрами:
  // #band, #location, #date та #ticketPrice
  // використання super для виклику конструктора базового класу
  // Створюємо getter для #ticketPrice, що повертає приватну
  // властивість #ticketPrice
  // Створюємо setter для #ticketPrice, що дозволяє змінити приватну
  // властивість #ticketPrice
  // Визначаємо метод info(), що виводить рядок в консоль
...
// console.log(new Vocalist("Name", "Band").info());
...
// console.log(new SongWriter("Songs").info());
...
// використання Object.assign() для успадкування властивостей
// songwriter для LeadSinger.prototype
